...
- **critical_gaps**: number from "Failure modes: \_\_\_ CRITICAL GAPS" in the summary
- **MODE**: the mode the user selected (SCOPE_EXPANSION / SELECTIVE_EXPANSION / HOLD_SCOPE / SCOPE_REDUCTION)
- **scope_proposed**: number from "Scope proposals: \_\_\_ proposed" in the summary (0 for HOLD/REDUCTION)
- **scope_accepted**: number from "Scope proposals: \_\_\_ accepted" in the summary (0 for HOLD/REDUCTION)

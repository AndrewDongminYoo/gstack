...
>([
  ...
  [
    "compare",
    {
      ...
      usage:
        'compare --images /path/*.png --output /path/board.html [--serve [--no-daemon] [--title "..."]]',
      flags: [
        "--images",
        "--output",
        "--serve",
  ...
  [
    ...
    {
      description:
        "Generate structured implementation prompt from approved mockup",
  ...
  [
    ...
    {
      description:
        "Extract design language from approved mockup into DESIGN.md",
  ...
  [
    ...
    {
      description:
        "Generate HTML timeline of all design explorations for a project",
      usage:
        "gallery --designs-dir ~/.gstack/projects/$SLUG/designs/ --output /path/gallery.html",
  ...
  [
    "serve",
    {
      ...
      usage:
        'serve --html /path/board.html [--no-daemon] [--title "..."] [--timeout 600]',
  ...
  [
    ...
    {
      description:
        "Manage the persistent design board daemon (sub-commands: status, stop)",

...
export const QUESTIONS = {
  ...
  "ship-release-pipeline-missing": {
    ...
    description:
      "New artifact added without CI/CD release pipeline — add now, defer to TODOs, or skip?",
  },
  "ship-test-failure-triage": {
    ...
    description:
      "Failing tests detected — fix before shipping or investigate root cause?",
  },
  ...
  "ship-greptile-comment-valid": {
    ...
    signal_key: "code-quality-care",
    description:
      "Greptile flagged a valid issue — fix, ack and ship, or mark false positive?",
  },
  "ship-greptile-comment-false-positive": {
    ...
    description:
      "Greptile comment looks like a false positive — reply to explain, fix anyway, or ignore silently?",
  },
  "ship-todos-create": {
  ...
  "ship-todos-reorganize": {
    ...
    description:
      "TODOS.md doesn't follow the recommended structure — reorganize now?",
  },
  ...
  "review-sql-safety": {
    ...
    description:
      "Potential SQL injection / unsafe query — fix or investigate further?",
  },
  ...
  "office-hours-mode-goal": {
    ...
    description:
      "What's your goal with this session? (Sets mode: startup vs builder)",
  },
  ...
  "office-hours-landscape-privacy-gate": {
    ...
    options: ["accept", "skip"],
    description:
      "Run a web search for landscape awareness? (Sends generalized terms to search provider.)",
  },
  "office-hours-approach-choose": {
    ...
    description:
      "Which implementation approach? (minimal viable vs ideal architecture vs creative lateral)",
  },
  ...
  "plan-ceo-review-mode": {
    ...
    signal_key: "scope-appetite",
    description:
      "Review mode: push scope up, cherry-pick expansions, hold scope, or cut to minimum?",
  },
  "plan-ceo-review-expansion-proposal": {
    ...
    signal_key: "scope-appetite",
    description:
      "Scope expansion proposal — add to plan, defer to TODOs, or skip?",
  },
  ...
  "plan-eng-review-todo-add": {
    ...
    description:
      "Proposed TODO item — add to TODOs, skip, or build in this PR?",
  },
  ...
  "plan-design-review-mode": {
    ...
    description:
      "Design review depth: expand for competitive edge, polish every touchpoint, or triage critical gaps?",
  },
  ...
  "plan-devex-review-persona": {
    ...
    door_type: "two-way",
    description:
      "Who is your target developer? (Determines persona for review.)",
  },
  "plan-devex-review-mode": {
    ...
    description:
      "DX review depth: expand for competitive advantage, polish every touchpoint, or triage critical gaps?",
  },
  "plan-devex-review-friction-fix": {
    ...
    signal_key: "devex-care",
    description:
      "Friction point in the developer journey — fix now, defer, or skip?",
  },
  ...
  "qa-tier": {
    ...
    description:
      "QA tier: quick (critical/high only), standard (+medium), or deep (+low)?",
  },
  ...
  "investigate-hypothesis-confirm": {
    ...
    description:
      "Root-cause hypothesis — accept, reject, or refine before proceeding to fix?",
  },
  ...
  "cso-global-scan-approval": {
    ...
    options: ["accept", "deny"],
    description:
      "Run a global security scan? (Scans files outside this branch.)",
  },
  "cso-finding-fix": {
    id: "cso-finding-fix",
    skill: "cso",
  ...
  "gstack-upgrade-inline": {
    ...
    description:
      "Upgrade gstack now? (Also: always auto-upgrade, snooze, or disable the prompt.)",
  },
  ...
  "preamble-telemetry-consent": {
    ...
    description:
      "Share usage data with gstack? community (recommended) / anonymous / off",
  },
  "preamble-proactive-behavior": {
    ...
    options: ["on", "off"],
    description:
      "Let gstack proactively suggest skills based on conversation context?",
  },
  ...
  "preamble-vendored-migration": {
    ...
    description:
      "This repo has vendored gstack (deprecated) — migrate to team mode?",
  },
  "preamble-completeness-intro": {
    ...
    options: ["accept", "skip"],
    description:
      "Open the Boil-the-Lake essay in your browser? (one-time intro)",
  },
  "preamble-cross-project-learnings": {
    ...
    options: ["accept", "reject"],
    description:
      "Enable cross-project learnings search? (local only, helpful for solo devs)",
  },
  ...
  "plan-tune-declared-dimension": {
    ...
    door_type: "two-way",
    description:
      "Self-declaration question (one per dimension during /plan-tune setup)",
  },
  "plan-tune-confirm-mutation": {
    ...
    options: ["accept", "reject"],
    description:
      "Confirm profile change before writing (user sovereignty gate for free-form edits)",
  },
  ...
  "autoplan-taste-decision": {
    ...
    description:
      "Autoplan surfaced a taste decision at the final gate — accept, override, or investigate?",
  },
  "autoplan-user-challenge": {
    ...
    description:
      "Both models agree your direction should change — accept, reject, or revise the plan?",
  },

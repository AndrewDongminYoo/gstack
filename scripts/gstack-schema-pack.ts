  ...
  fields: [
    {
      ...
      type: "string",
      required: true,
      description: "gstack/user-profile",
    },
    {
      name: "slug",
      type: "string",
      required: true,
      description: "gstack/user-profile/<user-slug>",
    },
    {
      name: "user_slug",
      type: "string",
      required: true,
      description: "Resolved per USER_SLUG_RESOLUTION_ORDER",
    },
    {
      name: "last_updated_by",
      type: "string",
      required: false,
      description: "Last skill that touched this page",
    },
    {
    ...
    {
      name: "pattern_statements",
      type: "string-array",
      required: false,
      description:
        'Bias tags from calibration (e.g., "under-expands on infra plans")',
    },
    {
      name: "taste_signals",
      type: "string-array",
      required: false,
      description: "Recurring design/eng preferences observed across reviews",
    },
  ],
  emits_links: [{ verb: "has_calibration", target_type: "gstack/take" }],
};
  ...
  fields: [
    {
      ...
      type: "string",
      required: true,
      description: "gstack/product",
    },
    {
      name: "slug",
      type: "string",
      required: true,
      description: "gstack/product/<project-slug>",
    },
    {
      name: "title",
      type: "string",
    ...
    },
    {
      ...
      type: "string",
      required: false,
      description: "/office-hours or /plan-ceo-review",
    },
    {
      name: "last_updated_at",
      type: "date",
  ...
  fields: [
    {
      ...
      type: "string",
      required: true,
      description: "gstack/goal",
    },
    {
      name: "slug",
      type: "string",
      required: true,
      description: "gstack/goal/<project-slug>/<goal-id>",
    },
    {
      name: "title",
      type: "string",
    ...
    },
    {
      ...
      type: "date",
      required: true,
      description: "When the user committed",
    },
    {
      name: "expected_resolution",
      type: "date",
      required: false,
      description: "ISO-8601; flips to expired after",
    },
    {
      name: "status",
      type: "enum",
      required: true,
      values: ["active", "resolved", "expired", "archived"],
    ...
    },
    {
      ...
      type: "string",
      required: false,
      description: "Filled when resolved",
    },
  ],
  emits_links: [{ verb: "belongs_to", target_type: "gstack/product" }],
};
  ...
  fields: [
    {
      ...
      type: "string",
      required: true,
      description: "gstack/developer-persona",
    },
    {
      name: "slug",
      type: "string",
      required: true,
      description: "gstack/developer-persona/<project-slug>",
    },
    {
      name: "persona",
      type: "string",
      required: true,
      description: "One-line target developer description",
    },
    {
      name: "tthw_measurements",
      type: "string-array",
      required: false,
      description: "Historical TTHW times with dates",
    },
    {
      name: "friction_patterns",
      type: "string-array",
      required: false,
      description: "Where developers get stuck",
    },
  ],
};
  ...
  fields: [
    {
      ...
      type: "string",
      required: true,
      description: "gstack/brand",
    },
    {
      name: "slug",
      type: "string",
      required: true,
      description: "gstack/brand/<project-slug>",
    },
    {
      name: "aesthetic",
      type: "string",
      required: false,
      description: 'e.g., "minimal/typographic"',
    },
    {
      name: "typography",
      type: "string",
      required: false,
      description: "Font system summary",
    },
    {
      name: "color_system",
      type: "string",
  ...
  fields: [
    {
      ...
      type: "string",
      required: true,
      description: "gstack/competitive-intel",
    },
    {
      name: "slug",
      type: "string",
      required: true,
      description: "gstack/competitive-intel/<project-slug>",
    },
    {
      name: "competitors",
      type: "string-array",
      required: false,
      description: "Named competitors with positioning notes",
    },
    {
      name: "benchmarks",
      type: "string-array",
      required: false,
      description: "Measured comparison points (TTHW etc.)",
    },
  ],
};
  ...
  fields: [
    {
      ...
      type: "string",
      required: true,
      description: "gstack/skill-run",
    },
    {
      name: "slug",
      type: "string",
      required: true,
      description: "gstack/skill-run/<project>/<skill>/<timestamp>",
    },
    {
      name: "skill",
      type: "string",
      required: true,
      description: "Skill name (e.g., plan-ceo-review)",
    },
    {
      name: "project",
      type: "string",
    ...
    },
    {
      ...
      type: "number",
      required: false,
      description: "Skill duration in seconds",
    },
    {
      name: "outcome",
      type: "enum",
    ...
    },
    {
      ...
      type: "string",
      required: false,
      description: "Mode chosen (for skills with mode)",
    },
    {
      name: "decisions",
      type: "number",
      required: false,
      description: "Count of AUQ decisions",
    },
    {
      name: "takes_written",
      type: "number",
      required: false,
      description: "Calibration bets written (E5)",
    },
  ],
  emits_links: [
  ...
  fields: [
    {
      ...
      type: "string",
      required: true,
      description: "gstack/take",
    },
    {
      name: "slug",
      type: "string",
      required: true,
      description: "gstack/take/<project>/<date>/<id>",
    },
    {
      name: "kind",
      type: "enum",
      required: true,
      values: ["bet", "hunch", "fact", "event"],
      description: "Take kind",
    },
    {
      name: "holder",
      type: "string",
      required: true,
      description: "User identity (whoami / user-slug)",
    },
    {
      name: "claim",
      type: "string",
      required: true,
      description: "The prediction text",
    },
    {
      name: "weight",
      type: "number",
      required: false,
      description: "0-1 confidence (per-skill from SKILL_CALIBRATION_WEIGHTS)",
    },
    {
      name: "since_date",
      type: "date",
      required: false,
      description: "When the take was written",
    },
    {
      name: "expected_resolution",
      type: "date",
    ...
    },
    {
      ...
      type: "date",
      required: false,
      description: "When marked resolved",
    },
    {
      name: "resolved_quality",
      type: "enum",
      required: false,
    ...
    },
    {
      ...
      type: "string",
      required: false,
      description: "Which skill wrote this bet",
    },
  ],
  emits_links: [
...
export function getRetentionPolicy(
  pageType: string,
): SchemaTypeDefinition["retention"] {
  const def = GSTACK_CORE_SCHEMA_PACK.page_types.find(
    (t) => t.type === pageType,
  );

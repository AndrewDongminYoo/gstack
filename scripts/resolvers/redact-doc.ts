...
export function generateRedactTaxonomyTable(
...
const SINKS: Record<string, SinkSpec> = {
  ...
  "pre-issue": {
    noun: "the issue body you're about to file",
    blockVerb: "file the issue",
  },
  "pre-archive": {
    noun: "the body about to be archived",
    blockVerb: "write the archive",
  },
  "pre-pr-body": {
    noun: "the composed PR body",
    blockVerb: "create/edit the PR",
  },
  "pre-pr-title": { noun: "the PR title", blockVerb: "set the PR title" },
  "pre-commit": {
    noun: "the generated docs about to be committed",
    blockVerb: "commit",
  },
};

export function generateRedactInvocationBlock(
  ctx: TemplateContext,
  args?: string[],
): string {

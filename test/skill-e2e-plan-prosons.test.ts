...
describeIfSelected(
  "Plan Prosons — Hard-stop Negative",
  ...
  () => {
    ...
    beforeAll(() => {
      planDir = setupPlanDir(
        "skill-e2e-plan-prosons-hardstop-neg-",
        TRADEOFF_PLAN,
        "plan-ceo-review",
      );
      outFile = path.join(planDir, "ask-capture.md");
...
describeIfSelected(
  "Plan Prosons — Neutral-posture Negative",
  ...
  () => {
    ...
    beforeAll(() => {
      planDir = setupPlanDir(
        "skill-e2e-plan-prosons-neutral-neg-",
        DOMINANT_PLAN,
        "plan-ceo-review",
      );
      outFile = path.join(planDir, "ask-capture.md");
...
describeIfSelected(
  "Plan Prosons — Hard-stop Positive",
  ...
  () => {
    ...
    beforeAll(() => {
      planDir = setupPlanDir(
        "skill-e2e-plan-prosons-hardstop-pos-",
        HARDSTOP_PLAN,
        "plan-ceo-review",
      );
      outFile = path.join(planDir, "ask-capture.md");
...
After writing the file, stop.`,
        ...
        const hasProsAndCons =
          countChars(captured, "✅") >= 1 && countChars(captured, "❌") >= 1;

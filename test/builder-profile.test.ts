...
describe("gstack-builder-profile", () => {
  ...
  describe("resource dedup", () => {
    test("aggregates resources across sessions", () => {
      writeProfile([
        makeEntry({
          resources_shown: ["https://url1.com", "https://url2.com"],
        }),
        makeEntry({
          resources_shown: ["https://url2.com", "https://url3.com"],
          date: "2026-04-02T00:00:00Z",
        }),
      ]);
      const r = runProfile();
    ...
    test("deduplicates identical URLs", () => {
      writeProfile([
        ...
        makeEntry({
          resources_shown: ["https://same.com"],
          date: "2026-04-02T00:00:00Z",
        }),
      ]);
      const r = runProfile();
  ...
  describe("last session data", () => {
    ...
    test("returns last design doc", () => {
      writeProfile([
        ...
        makeEntry({
          design_doc: "path/to/design-2.md",
          date: "2026-04-02T00:00:00Z",
        }),
      ]);
      const r = runProfile();
  ...
  describe("malformed JSONL handling", () => {
    test("skips malformed lines, counts valid ones", () => {
      ...
      const lines = [
        ...
        "{broken json",
        JSON.stringify(
          makeEntry({ project_slug: "good-2", date: "2026-04-02T00:00:00Z" }),
        ),
      ];
